...
export default function AboutMe() {
  return (
    <div className="mt-5 space-y-4 text-sm leading-7 text-zinc-300 sm:text-base">
      <p>
        From{" "}
        <span className="font-medium text-indigo-300">Moshav Yashresh</span> to
        the energy of{" "}
        <span className="font-medium text-cyan-300">Tel Aviv</span>, my journey
        has always been about growth, challenge, and purpose.
      </p>
